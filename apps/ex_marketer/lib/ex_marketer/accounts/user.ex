defmodule ExMarketer.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ExMarketer.Repo)
  ...
  """
  def valid_password?(%ExMarketer.Accounts.User{hashed_password: hashed_password}, password)
